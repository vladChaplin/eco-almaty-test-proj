...
import kz.enactus.ecoalmaty.api.exception.EmailIsAlreadyRegisteredException
import kz.enactus.ecoalmaty.api.exception.UsernameIsAlreadyRegisteredException
...
class SignUpService(
    ...
    fun signUp(request: SignUpRequest): SignUpResponse {
        ...
        userRepository.findByUsername(request.username).ifPresent { throw UsernameIsAlreadyRegisteredException() }
